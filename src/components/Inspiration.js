...
const Inspiration = () => {
  ...
  return (
    <div className="bg-[#F7F7F7] py-10">
      <div className="w-full m-auto max-w-7xl px-4">
        {/* Title */}
        ...
        {/* Tabs */}
        <div className="flex border-b mb-6 space-x-6 text-sm font-medium overflow-x-auto">
          <button
        ...
        {/* Content */}
        {activeTab === 'tips' && (
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-6 text-sm">
            <div>
        ...
        {activeTab === 'apartments' && (
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6 text-sm">
            {[
            ...
            <div>
              <h3 className="font-semibold text-blue-600 cursor-pointer">
                Show more
              </h3>
            </div>
          </div>
